!(function (c) {
  c.fn.hoverIntent = function (e, t, n) {
    ...
    var o,
      ...
      a,
      u,
      s = { interval: 100, sensitivity: 6, timeout: 50 },
      s =
        "object" == typeof e
          ? c.extend(s, e)
          : c.isFunction(t)
          ? c.extend(s, { over: e, out: t, selector: n })
          : c.extend(s, { over: e, out: e, selector: t }),
      l = function (e, t) {
        if (
          ((t.hoverIntent_t = clearTimeout(t.hoverIntent_t)),
          Math.sqrt((a - o) * (a - o) + (u - i) * (u - i)) < s.sensitivity)
        )
          return (
            c(t).off("mousemove.hoverIntent", r),
            (t.hoverIntent_s = !0),
            s.over.apply(t, [e])
          );
        (a = o),
      ...
      t = function (e) {
        ...
        o.hoverIntent_t && (o.hoverIntent_t = clearTimeout(o.hoverIntent_t)),
          "mouseenter" === e.type
            ? ((a = n.pageX),
              (u = n.pageY),
              c(o).on("mousemove.hoverIntent", r),
              o.hoverIntent_s ||
                (o.hoverIntent_t = setTimeout(function () {
                  l(n, o);
                }, s.interval)))
            : (c(o).off("mousemove.hoverIntent", r),
              o.hoverIntent_s &&
                (o.hoverIntent_t = setTimeout(function () {
                  var e, t;
                  (e = n),
  ...
  (Shopify.Image = {
    ...
    switchImage: function (e, t, n) {
      ...
      e &&
        t &&
        ((o = this.imageSize(t.src)),
        (o = this.getSizedImageUrl(e.src, o)),
        n ? n(o, e, t) : (t.src = o));
    },
    ...
    getSizedImageUrl: function (e, t) {
      ...
      (e = e.split(n[0])), (n = n[0]);
      return this.removeProtocol(e[0] + "_" + t + n);
    },
  ...
  (function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
      ...
      ? define(t)
      : (((e = e || self).Vimeo = e.Vimeo || {}), (e.Vimeo.Player = t()));
  })(this, function () {
    "use strict";
    function e(e, t) {
    ...
    function s() {
      ...
      if ((a(this, "_id", "_WeakMap_" + f() + "." + f()), 0 < arguments.length))
    ...
    (p =
      ...
      (p.WeakMap =
        (a(s.prototype, "delete", function (e) {
          if ((d(this, "delete"), !h(e))) return !1;
          var t = e[this._id];
          return !(!t || t[0] !== e || (delete e[this._id], 0));
        }),
        a(s.prototype, "get", function (e) {
          if ((d(this, "get"), h(e))) {
            var t = e[this._id];
            return t && t[0] === e ? t[1] : void 0;
          }
        }),
        a(s.prototype, "has", function (e) {
          if ((d(this, "has"), !h(e))) return !1;
          var t = e[this._id];
          return !(!t || t[0] !== e);
        }),
        a(s.prototype, "set", function (e, t) {
          if ((d(this, "set"), !h(e)))
            throw new TypeError("Invalid value used as weak map key");
          var n = e[this._id];
          return n && n[0] === e ? (n[1] = t) : a(e, this._id, [e, t]), this;
        }),
        a(s, "_polyfill", !0),
        s)));
    var p,
        ...
        (o = function () {
          ...
          var m = e(
            ...
            !(o = {
              ...
              drain: function () {
                var e = r;
                for (r = i = n = void 0; e; ) e.fn.call(e.self), (e = e.next);
              },
            })
          );
          return (
            e((y.prototype = m), "__NPO__", 0, !1),
            e(y, "resolve", function (n) {
    ...
    function w(e, t, n) {
      var o = v.get(e.element) || {};
      if (!o[t]) return 1;
      if (!n) return (o[t] = []), v.set(e.element, o), 1;
      n = o[t].indexOf(n);
      return (
        -1 !== n && o[t].splice(n, 1),
        v.set(e.element, o),
    ...
    function _(i, e, t) {
      ...
      return new Promise(function (t, n) {
        ...
        var e,
          o = "https://vimeo.com/api/oembed.json?url="
            .concat(encodeURIComponent(i), "&domain=")
            .concat(window.location.hostname);
        for (e in a)
          a.hasOwnProperty(e) &&
            (o += "&".concat(e, "=").concat(encodeURIComponent(a[e])));
        var r = new (
        ...
        (e(S.prototype, [
            ...
            value: function (n) {
              ...
              return new y(function (e, t) {
                return o
                  .ready()
                  .then(function () {
                    m(o, n, { resolve: e, reject: t }), I(o, n, r);
                  })
                  .catch(t);
              });
            },
              ...
              return new y(function (e, t) {
                return (
                  ...
                  o
                    .ready()
                    .then(function () {
                      m(o, n, { resolve: e, reject: t }), I(o, n);
                    })
                    .catch(t)
                );
              });
            ...
            value: function (n, o) {
              ...
              return new y(function (e, t) {
                ...
                return r
                  .ready()
                  .then(function () {
                    m(r, n, { resolve: e, reject: t }), I(r, n, o);
                  })
                  .catch(t);
              });
            },
          },
          {
            ...
            value: function (e, t) {
              ...
              0 === g(this, "event:".concat(e)).length &&
    ...
    function S(r) {
      ...
      var o = new y(function (a, u) {
        var e = function (e) {
          if (l(e.origin) && s.element.contentWindow === e.source) {
            ...
            if (e || n)
              return s.element.setAttribute("data-ready", "true"), void a();
            (o = s),
              (n = []),
              (r = E((r = t))).event
                ? ("error" === r.event &&
                    g(o, r.data.method).forEach(function (e) {
                      var t = new Error(r.data.message);
                      (t.name = r.data.name),
                        e.reject(t),
                        w(o, r.data.method, e);
                    }),
                  (n = g(o, "event:".concat(r.event))),
                  (i = r.data))
                : !r.method ||
                  ((t = (function (e, t) {
                    var n = g(e, t);
              ...
              n.forEach(function (e) {
                try {
                  if ("function" == typeof e) return void e.call(o, i);
                  e.resolve(i);
                } catch (e) {}
              });
          }
        ...
        n.addEventListener
          ...
          : n.attachEvent && n.attachEvent("onmessage", e),
      ...
      return (
        ...
        "IFRAME" === this.element.nodeName && I(this, "ping"),
        this
      );
    }
    return (
      t ||
        ...
        (function (e) {
          var o = 0 < arguments.length && void 0 !== e ? e : document;
  ...
  (jQuery.cookie = function (e, t, n) {
    ...
    n.expires &&
      ...
      ("number" == typeof n.expires
        ? (l = new Date()).setTime(l.getTime() + 24 * n.expires * 60 * 60 * 1e3)
        : (l = n.expires),
  ...
  (function (e) {
    ...
    function s(e) {
      ...
      return (
        e.each(function () {
          ...
          null !== n && Math.floor(Math.abs(o - t)) <= 1
      ...
      c = (a.fn.matchHeight = function (e) {
        ...
        return (
          (this.length <= 1 && !e.target) ||
            (c._groups.push({ elements: this, options: e }), c._apply(this, e)),
          this
        );
      });
    (c.version = "master"),
      ...
      (c._apply = function (e, t) {
        ...
        return (
            ...
            t.each(function () {
              ...
              (r.target && e.is(r.target)) ||
                ("border-box" !== e.css("box-sizing") &&
                  ((t +=
                    u(e.css("border-top-width")) +
                    u(e.css("border-bottom-width"))),
                  (t += u(e.css("padding-top")) + u(e.css("padding-bottom")))),
          ...
          c._maintainScroll &&
            a(window).scrollTop((i / t) * a("html").outerHeight(!0)),
          this
        );
      }),
    ...
    function i(e) {
      c._beforeUpdate && c._beforeUpdate(e, c._groups),
        a.each(c._groups, function (e) {
          var t = this;
          t.elements.length &&
            setTimeout(function () {
    ...
    (YTPlayer = {
      ...
      init: function (e, t) {
        ...
        return (
          ...
          (r.defaults.events = {
            onReady: function (e) {
              r.onPlayerReady(e),
                r.options.pauseOnScroll && r.pauseOnScroll(),
                "function" == typeof r.options.callback &&
                  r.options.callback.call(this);
            },
            onStateChange: function (e) {
              1 === e.data
                ? (r.$node.find("img").fadeOut(400), r.$node.addClass("loaded"))
                : 0 === e.data &&
                  r.options.repeat &&
                  r.player.seekTo(r.options.start);
            },
          }),
          (r.options = a.extend(!0, {}, r.defaults, r.userOptions)),
          (r.options.height = Math.ceil(r.options.width / r.options.ratio)),
          (r.ID = new Date().getTime()),
          (r.holderID = "YTPlayer-ID-" + r.ID),
          r.options.fitToBackground
            ? r.createBackgroundVideo()
            : r.createContainerVideo(),
          r.$window.on("resize.YTplayer" + r.ID, function () {
            r.resize(r);
          }),
          (n = r.onYouTubeIframeAPIReady.bind(r)),
          ((t = i.createElement("script")).id = "youtube-sdk"),
          (e = i.getElementsByTagName("head")[0]),
          "file://" == u.location.origin
          ...
          (t = e = null),
          (o = n),
          "undefined" == typeof YT && void 0 === u.loadingPlayer
            ? ((u.loadingPlayer = !0),
              (u.dfd = a.Deferred()),
      ...
      resize: function (e) {
        ...
        var n,
          ...
          i = a("#" + e.holderID);
        o / e.options.ratio < r
          ? ((n = Math.ceil(r * e.options.ratio)),
            i
              .width(n)
              .height(r)
              .css({ left: (o - n) / 2, top: 0 }))
          : ((e = Math.ceil(o / e.options.ratio)),
            i
              .width(o)
              .height(e)
              .css({ left: 0, top: (r - e) / 2 })),
          (t = i = null);
      },
      onYouTubeIframeAPIReady: function () {
        (theme.ProductVideo.youtubeApiLoaded = !0),
          theme.ProductVideo.loadVideos(theme.ProductVideo.hosts.youtube);
        this.player = new u.YT.Player(this.holderID, this.options);
      },
      ...
      destroy: function () {
        ...
        e.$node
          ...
          .removeData("ytPlayer")
          .removeClass("loaded"),
          e.$YTPlayerString.remove(),
          a(u).off("resize.YTplayer" + e.ID),
          a(u).off("scroll.YTplayer" + e.ID),
          (e.$body = null),
          (e.$node = null),
          (e.$YTPlayerString = null),
          e.player.destroy(),
          (e.player = null);
      },
    }),
      (a.fn.scrollStopped = function (e) {
        var t = a(this),
          n = this;
        t.scroll(function () {
          t.data("scrollTimeout") && clearTimeout(t.data("scrollTimeout")),
            t.data("scrollTimeout", setTimeout(e, 250, n));
        });
      }),
...
function setUnitPrice(variant) {
  ...
  return (
    Shopify.formatMoney(variant.unit_price, DT_THEME.moneyFormat) +
    "/" +
    baseUnit
  );
}
...
theme.numberCounter = (function () {
  function numberCounter(container) {
    ...
    $(".inview-" + initInview + "-initialized").bind(
      "inview",
      function (event, visible) {
        if (visible) {
          ...
          $(".dt-sc-number-counter-value").each(function () {
            ...
            $({ counter_value: $this.text() }).animate(
              {
                ...
                complete: function () {
                  $this.text(
                    this.counter_value
                      .toString()
                      .replace(/\B(?=(\d{3})+(?!\d))/g, ",")
                  ); //For placing comma(,) after particular digit
                },
              }
            );
          });
...
theme.HomeSlideshow = (function () {
  function HomeSlideshow(container) {
    ...
    var sliderActive = (this.sliderActive = $(
      "#home-slider-" + sectionId
    ).length);
    var sliderSpeed = $container.attr("data-animation-speed");
    var sliderAuto = $container.attr("data-autoPlay");
    if (sliderAuto == "true")
      var autoplay = sliderSpeed > 0 ? { delay: +sliderSpeed } : false;
    else {
      autoplay = "false";
    }
...
theme.ProductPage = (function () {
  ...
  function Product(container) {
    ...
    var rteVideo =
      $container.find(".product-single__description.rte iframe").length ||
      false;

    if (rteVideo) {
      $container
        .find(".product-single__description.rte iframe")
        .wrap("<div class='dT-video-wrapper'></div>");
    }
    ...
    this.inventoryAvailability = container.querySelector(
      this.settings.selectors.inventoryAvailability
    );
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    dT_Zoom: function () {
      if (
        ...
        this.settings.selectors.zoomEnabled.length
      ) {
        if ($(window).width() > 767) {
      ...
      for (var i = 0, length = productJSON.variants.length; i < length; i++) {
        ...
        if (productVariants.available) {
          for (
            ...
            this.$container
              .find(
                '.swatch[data-option-index="' + j + '"] .' + variantOption + ""
              )
              .removeClass("soldout")
              .addClass("available")
              .find(":radio")
    ...
    dT_init_Swiper: function () {
      ...
      this.settings.swiperObjects.mySwiper = new Swiper(
        ".swiper-main-" + this.settings.sectionId,
        {
          direction: "horizontal",
          pagination: {
      ...
      var gallerySwiperThumbsVert =
        (this.settings.swiperObjects.gallerySwiperThumbsVert = new Swiper(
          "#swiper-gallery-thumbs-vert-" + this.settings.sectionId,
          {
            direction: "vertical",
            initialSlide: 2,
            spaceBetween: 10,
      ...
      this.settings.swiperObjects.gallerySwiperVert = new Swiper(
        "#swiper-gallery-vert-" + this.settings.sectionId,
        {
          initialSlide: 2,
          spaceBetween: 10,
          slidesPerView: 1,
      ...
      if (
        typeof this.settings.swiperObjects.gallerySwiperVert.controller !=
        "undefined"
      ) {
        this.settings.swiperObjects.gallerySwiperVert.controller.control =
          this.settings.swiperObjects.gallerySwiperThumbsVert;
        this.settings.swiperObjects.gallerySwiperThumbsVert.controller.control =
          this.settings.swiperObjects.gallerySwiperVert;
      }

      // Swiper Horizontal scroll

      var gallerySwiperThumbs =
        (this.settings.swiperObjects.gallerySwiperThumbs = new Swiper(
          "#swiper-gallery-thumbs-" + this.settings.sectionId,
          {
            loop: false,
            spaceBetween: 10,
            slidesPerView: 4,
      ...
      this.settings.swiperObjects.gallerySwiper = new Swiper(
        "#swiper-gallery-" + this.settings.sectionId,
        {
          loop: false,
          spaceBetween: 10,
          thumbs: {
    ...
    initProductVariant: function () {
      ...
      $(
        ".main-product-select-" + productJSON.id + " .single-option-selector"
      ).on("change", function () {
        var option1 =
            $(
              ".main-product-select-" +
        ...
        for (var i = 0, length = productVariantObj.length; i < length; i++) {
          ...
          if (
            option1 == productVar.option1 &&
            option2 == productVar.option2 &&
            option3 == productVar.option3
          ) {
            flag = false;
      ...
      var selectedOptionsLength = $(
        "#ProductSelect-" + productJSON.id + " option[selected]"
      ).length;
      ...
      if (productJSON.options.size == 1 && productJSON.options[0] != "Title") {
        $(".selector-wrapper:eq(0)").prepend(
          "<label>" + productJSON.options[0] + "</label>"
        );
      }

      if (
        productJSON.variants.size == 1 &&
        productJSON.variants[0].title.indexOf("Default") + 1
      ) {
      ...
      if (!(str.indexOf("?variant=") + 1)) {
        ...
        for (variant in productJSON.variants) {
          if (
            productJSON.variants[variant].available &&
            found_one_in_stock == false
          ) {
            ...
            for (option in productJSON.options) {
              ...
              if (i >= 0) {
                $(
                  ".main-product-select-" +
                    productJSON.id +
                    " .single-option-selector:eq(" +
                    i +
                    ")"
                )
                  .val(
                    productJSON.variants[variant].options[i].replace(
                      /\s{2,}/g,
                      " "
                    )
                  )
    ...
    productVariantCallback: function (variant, selector) {
      ...
      var buy_now_btn = $(this.settings.selectors.addToCart)
        .closest("form")
      ...
      if (variant) {
        ...
        for (var i = 0, length = variant.options.length; i < length; i++) {
          ...
          var radioButtonDiv = form.find(
            '.swatch[data-option-index="' + i + '"] div.swatch-element'
          )[num];
      ...
      if (variant) {
        if (
          ...
          (UrlTrigger || home_featured_product_media)
        ) {
          var slideId = variant.featured_media.id;
          if (
            typeof this.settings.swiperObjects.gallerySwiper.controller !=
            "undefined"
          ) {
            this.settings.swiperObjects.gallerySwiper.slideTo(
              $("#" + slideId).index()
            );
          } else if (
            typeof this.settings.swiperObjects.gallerySwiperVert.controller !=
            ...
            this.settings.swiperObjects.gallerySwiperVert.slideTo(
              $("#" + slideId).index()
            );
          } else {
            this.settings.swiperObjects.mySwiper.slideTo(
              $("#" + slideId).index()
            );
          }
        }
        ...
        $(this.settings.selectors.productPrice).html(
          Shopify.formatMoney(variant.price, DT_THEME.moneyFormat)
        );
        ...
        if (variant.compare_at_price > variant.price) {
          $(this.settings.selectors.comparePrice)
            .html(
              Shopify.formatMoney(
                ...
                DT_THEME.moneyFormat
              )
            )
            .removeClass("hide");

          $(this.settings.selectors.price).addClass(
            this.settings.selectors.saleClasses
          );
          ...
          $(this.settings.selectors.price).removeClass(
            this.settings.selectors.saleClasses
          );
        }
        ...
        if (jQuery.type(variant) === "null") {
          ...
          if (variant.sku && variantSkuData) {
            variantSkuData
              .addClass("attributes-visible")
              .removeClass("attributes-hidden");
            ...
            variantSkuData
              .addClass("attributes-hidden")
              .removeClass("attributes-visible");
            variantSku.html("");
            if (variantSkuData.is(":last-child")) {
          ...
          if (InventoryProduct) {
            InventoryProduct.addClass("attributes-visible").removeClass(
              "attributes-hidden"
            );
            var main_product_select = $("#ProductSelect-" + selector),
              optionsLength = main_product_select.find("option").length;
            for (var i = 0; i <= optionsLength; i++) {
              var currentOption = main_product_select.find(
                "option:nth-child(" + i + ")"
              );
              if (currentOption.val() == variant.id) {
                var variant_inventory_management = currentOption.attr(
                  "data-inventory_management"
                );
                var variant_inventory_policy = currentOption.attr(
                  "data-inventory_policy"
                );
                var variant_inventory_quantity = currentOption.attr(
...
theme.CollectionPage.prototype = _.assignIn(
  {},
  theme.CollectionPage.prototype,
  {
    onSelect: function () {
...
function dt_QuickCallback(variant, selector) {
  ...
  if (variant) {
    var indexArray = [];
    $(
      "[data-id='" + selector + "'] .single-option-selector option:selected"
    ).each(function () {
      indexArray.push($(this).index());
    });
  ...
  if (variant) {
    ...
    if (comparePrice.length) {
      if (variant.compare_at_price > variant.price) {
        comparePrice
          .html(
            Shopify.formatMoney(variant.compare_at_price, DT_THEME.moneyFormat)
          )
          .show();
  ...
  sectionContainer.find(".quick-view-btn").on("click", function (e) {
    if ($(this).hasClass("quick-view-btn-opened")) {
      ...
      var productId = $(this).attr("data-product-id"),
        ...
        btn = $(this);
      $("#quick-shop-modal-inner-" + productId).load(
        quick_view_url,
        function (resp) {
      ...
      $(this).magnificPopup({
        ...
        callbacks: {
          ...
          ajaxContentAdded: function () {
            ...
            var select = $(".mfp-move-from-top").find(
              ".SingleOptionSelector-0"
            );
            dt_QuickShopWindow(btn, productId);
...
function dt_QuickShopWindowReady(productId, sectionId) {
  ...
  var product = JSON.parse(
    document.getElementById("dt_QuickViewJson-" + productId).innerHTML
  );
  ...
  if (
    ...
    product.variants[0].title.indexOf("Default") >= 0
  ) {
  ...
  for (var i = 0, length = productJSON.variants.length; i < length; i++) {
    ...
    if (productVariants.available) {
      for (
        ...
        variantOption = textToDownCase(variantOption);
        quickShopScreen
          .find('.swatch[data-option-index="' + j + '"] .' + variantOption + "")
          .removeClass("soldout")
          .addClass("available")
          .find(":radio")
          .removeAttr("disabled");
  ...
  $(
    "[data-id=" + product.id + "] .single-option-selector option:selected"
  ).each(function () {
    indexArray.push($(this).index());
  });
  var form = jQuery("#dt-sc-quick-" + product.id).closest("form");
  var variantIndex = jQuery(
    "#dt-sc-quick-" + product.id + " option:selected"
  ).index();
  if (variantIndex >= 0) {
    ...
    swiperCarousel = new Swiper(".quick-swiper-" + productId, {
      ...
      on: {
        transitionEnd: function () {
          ...
          var $newMedia = $(slider.$el)
            .find(".swiper-slide")
            .eq(index)
            .find("[data-product-single-media-wrapper]");
          var $currentMedia = $(".quick-swiper-container").find(
...
function dt_Quantity(sectionId) {
  $(".btn-number-" + sectionId).click(function (e) {
    ...
    var input = $(this)
      .closest(".product-form__item--quantity")
  ...
  $(document).on("click", ".dt-sc-accordion-btn", function () {
    if (!open_accordion) {
      ...
      var active_accordion = $(this).index(".dt-sc-accordion-btn"),
        active_accordion_height = $(".dt-sc-accordion-content-inner")
          .eq(active_accordion)
          .outerHeight();
      $(".dt-sc-accordion-btn h5").removeClass("active");
      $(this).find("h5").addClass("active");
      $(".dt-sc-accordion-content").stop().animate({ height: 0 }, transition);
      $(".dt-sc-accordion-content")
        .eq(active_accordion)
        .stop()
        .animate({ height: active_accordion_height }, transition);
      setTimeout(function () {
...
$(document).ready(function () {
  ...
  sections.register(
    ...
    theme.indexProductCarousel
  );
  sections.register(
    "product-sidebar-carousel-section",
    theme.productSidebarCarousel
  );
...
$(".announcement-bar a.close").bind("click", function () {
  ...
  $.cookie("announcementCookie", "closed", { expires: 1, path: "/" });
});

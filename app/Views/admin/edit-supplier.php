										...
										<div class="row">
											...
											<div class="col-12 col-sm-6">
												<div class="form-group">
													<label>Tên</label>
													<input type="text" class="form-control" name="supplier_name" value="<?= $supplier['name']?>">
												</div>
											</div>
                                            <div class="col-12 col-sm-6">
												<div class="form-group">
													<label>Số điện thoại</label>
													<input type="text" class="form-control" name="supplier_phone" value="<?= $supplier['phone']?>">
												</div>
											</div>
                                            <div class="col-12 col-sm-6">
												<div class="form-group">
													<label>Email</label>
													<input type="text" class="form-control" name="supplier_email" value="<?= $supplier['email']?>">
												</div>
											</div>
                                            <div class="col-12 col-sm-6">
												<div class="form-group">
													<label>Địa chỉ</label>
													<input type="text" class="form-control" name="supplier_addr" value="<?= $supplier['address']?>">
												</div>
											</div>
											<div class="col-12">

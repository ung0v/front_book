										...
										<div class="row">
											...
											<div class="col-12 col-sm-6">
												<div class="form-group">
													<label>Tên</label>
													<input type="text" class="form-control" name="shipping_name" value="<?= $shipping['name']?>">
												</div>
											</div>
                                            <div class="col-12 col-sm-6">
												<div class="form-group">
													<label>Số điện thoại</label>
													<input type="text" class="form-control" name="shipping_phone" value="<?= $shipping['phone']?>">
												</div>
											</div>
                                            <div class="col-12 col-sm-6">
												<div class="form-group">
													<label>Email</label>
													<input type="text" class="form-control" name="shipping_email" value="<?= $shipping['email']?>">
												</div>
											</div>
                                            <div class="col-12 col-sm-6">
												<div class="form-group">
													<label>Địa chỉ</label>
													<input type="text" class="form-control" name="shipping_addr" value="<?= $shipping['address']?>">
												</div>
											</div>
											<div class="col-12">
